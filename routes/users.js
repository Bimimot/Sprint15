...
const { getUsers, getUserById, postUser } = require('../controllers/users'); // импорт методов поиска всех пользователей из контроллера

// const usersPath = path.join(path.dirname(__dirname), 'data', 'users.json');
// собрали абсолютный путь к файлу users.json
